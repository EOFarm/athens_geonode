...
RUN mkdir -p /usr/src/athens_geonode
...
COPY src /usr/src/athens_geonode/
WORKDIR /usr/src/athens_geonode
...
RUN chmod +x /usr/src/athens_geonode/tasks.py \
    && chmod +x /usr/src/athens_geonode/entrypoint.sh
...
# ENTRYPOINT /usr/src/athens_geonode/entrypoint.sh
