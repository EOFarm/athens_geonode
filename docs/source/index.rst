...
Το GeoNode είναι λογισμικό ανοιχτού κώδικα και είναι επίσημο έργο του `OSGeo`_ ("Open Source Geospatial Foundation").
...
σύμφωνα με τους όρους που αναφέρονται στη «:ref:`license`».

.. _«Χορήγηση άδειας χρήσης γεωχωρικών δεδομένων Δήμου Αθηναίων»: license
...
:ref:`searching`
    ...
    Για περισσότερες πληροφορίες επισκεφτείτε τη σελίδα «:ref:`searching`».
...
:ref:`maps`
    ...
    Για περισσότερες πληροφορίες επισκεφτείτε τη σελίδα «:ref:`maps`».

:ref:`layers`
    Θεματικά επίπεδα GIS με πληροφορίες, όπως τα διοικητικά όρια του Δήμου, τις κοινωνικές υπηρεσίες του, πολεοδομικά θέματα κλπ.

    Για περισσότερες πληροφορίες επισκεφτείτε τη σελίδα «:ref:`layers`».


:ref:`documents`
    Χάρτες σε μορφή pdf και έγγραφα συνδεδεμένα με χαρτογραφικά υπόβαθρα, όπως ΦΕΚ και Αποφάσεις Δημοτικού Συμβουλίου κλπ.

    Για περισσότερες πληροφορίες επισκεφτείτε τη σελίδα «:ref:`documents`».

:ref:`services`
    Χρήσιμες συνδέσεις με τον παγκόσμιο ιστό.

    Για περισσότερες πληροφορίες επισκεφτείτε τη σελίδα «:ref:`services`».

:ref:`apps`
    Εφαρμογές (μελλοντικά)

    Για περισσότερες πληροφορίες επισκεφτείτε τη σελίδα «:ref:`apps`».
